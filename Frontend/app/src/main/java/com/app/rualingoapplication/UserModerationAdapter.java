...
public class UserModerationAdapter extends RecyclerView.Adapter<UserModerationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Role distinction logic: 1 = Admin, 2 = Student
        ...
        boolean isAdmin = (roleId != null && roleId == 1) || 
                          "1".equals(roleStr) || 
                          (roleStr != null && roleStr.toUpperCase().contains("ADMIN")) ||
                          usernameLower.contains("admin");
        ...
        holder.btnHistory.setOnClickListener(v -> listener.onHistoryClick(user));
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        MaterialButton btnDelete, btnPromote, btnHistory;
