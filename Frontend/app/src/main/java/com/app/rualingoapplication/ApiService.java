...
public interface ApiService {
    ...
    @GET("api/exercises")
    Call<List<Question>> getExercises(@Query("lessonId") Long lessonId);
    ...
    // Lessons (CRUD)
    @GET("api/lessons")
    Call<List<Lesson>> getLessons(@Query("courseId") Long courseId);
    ...
    @POST("api/account/courses/{courseId}")
    Call<Void> enrollInCourse(@Path("courseId") Long courseId);

    // Users (CRUD)
    @GET("api/account/lessons/completed")
    Call<List<Map<String, Object>>> getCompletedLessons();

    @POST("api/users/{userId}/responses")
    Call<Void> saveUserResponse(@Path("userId") Long userId, @Body Map<String, Object> payload);
    ...
    Call<List<Map<String, Object>>> viewUserActivity(@Path("userId") Long userId);

    @POST("api/users/{userId}/activity-logs")
    Call<User> logUserActivity(@Path("userId") Long userId, @Body Map<String, Object> payload);
    ...
    @POST("api/admin/import/full-curriculum")
    ...
    // Vocabulary
    @GET("api/vocabulary")
    Call<List<VocabularyItem>> getVocabulary(@Query("courseId") Long courseId, @Query("topic") String topic, @Query("lessonId") Long lessonId);
    ...
    Call<ChatMessage> askRua(@Body Map<String, Object> payload);
}
